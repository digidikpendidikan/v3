...
@section('title')
    <title>Admin Digidik -  Semua Kelas</title>
@endsection
...
@section('heading')
    ...
    <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
        <!--begin::Heading-->
        <h1 class="fs-1 fw-bolder text-dark">Semua Kelas</h1>
        <!--end::Heading-->
        <!--begin::Breadcrumb-->
...
<div class="card card-custom card-stretch gutter-b mt-6">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark">Berikut Kelas Video Digidik</span>
            <span class="text-muted mt-3 font-weight-bold font-size-sm">Masing-masing kelas memiliki beberapa mata pelajaran.</span>
        </h3>
                            ...
                            @foreach($group as $data)
                                <tr>
                                    ...
                                    <td class="pl-0">
                                        ...
                                        <span class="text-muted font-weight-bold d-block">Slug: {{$data->slug}}, Jenjang: {{$data->level->nama}}</span>
                                    </td>
                                    <td class="text-right">
                                    ...
                                    <td class="text-right pr-0">
                                        <a href="{{route('admin.video.group.edit',$data->id)}}" class="btn btn-icon btn-light btn-sm">
                                        ...
                                        <a target="_blank" href="{{route('video.level',$data->level->slug)}}" class="btn btn-icon btn-light btn-sm">
