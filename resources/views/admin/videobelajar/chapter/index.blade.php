...
@section('title')
    <title>Admin Digidik -  Semua Bab</title>
@endsection
...
@section('heading')
    ...
    <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
        <!--begin::Heading-->
        <h1 class="fs-1 fw-bolder text-dark">Semua bab</h1>
        <!--end::Heading-->
        <!--begin::Breadcrumb-->
...
</svg><!--end::Svg Icon--></span>Tambah Bab di Menu Mapel</a>
</div>    
                            ...
                            @foreach($chapter as $data)
                                <tr>
                                    ...
                                    <td class="pl-0">
                                        ...
                                        <span class="text-muted font-weight-bold d-block">Slug: {{$data->slug}}, Kelas: {{$data->subject->nama}}</span>
                                    </td>
                                    <td class="text-right">
