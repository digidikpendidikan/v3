            ...
            <div class="hover-scroll-y mb-10" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_aside_nav" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-offset="0px">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="Selamat Datang">
                        <!--begin::Nav link-->
                        <a class="nav-link btn btn-icon btn-active-color-danger btn-color-gray-600 btn-active-light @if(Request::is('profil/*')) active @endif @if(Request::is('/')) active @endif" data-bs-toggle="tab" href="#kt_aside_nav_tab_projects">
                    ...
                    <!--end::Nav item-->
                    <!--begin::Nav item-->
                    <li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="Video Belajar">
                        <!--begin::Nav link-->
                        <a class="nav-link btn btn-icon btn-active-color-primary btn-color-gray-600 btn-active-light @if(strpos($routeName, 'video') === 0) active @endif" data-bs-toggle="tab" href="#kt_aside_nav_tab_menu">
        ...
        <div class="aside-footer d-flex flex-column align-items-center flex-column-auto" id="kt_aside_footer">
            ...
            <div class="d-flex align-items-center mb-2">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                    <!--begin::Heading-->
                    <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10 text-black" style="background-image:url('assets/media/misc/dropdown-header-bg.png')">
                        <!--begin::Title-->
                        <h3 class="fw-bold">Tentang Digidik</h3>
                        <!--end::Title-->
                    </div>
                    <!--end::Heading-->
                    <!--begin:Nav-->
                    <div class="row g-0">
                        ...
                        <div class="col-6">
                            <a href="" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
                                ...
                                <!--end::Svg Icon-->
                                <span class="fs-5 fw-bold text-black mb-0">Tentang Digidik</span>
                            </a>
                        </div>
                        <!--end:Item-->
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom">
                                ...
                                <!--end::Svg Icon-->
                                <span class="fs-5 fw-bold text-black mb-0">Kontak Kami</span>
                            </a>
                        </div>
                        <!--end:Item-->
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end">
                                ...
                                <!--end::Svg Icon-->
                                <span class="fs-5 fw-bold text-black mb-0">Kebijakan Privasi</span>
                                <span class="fs-7 text-black">Aturan Penggunaan</span>
                            </a>
                        </div>
                        <!--end:Item-->
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light">
                                ...
                                <!--end::Svg Icon-->
                                <span class="fs-5 fw-bold text-black mb-0">Sponsor</span>
                                <span class="fs-7 text-black">Dan Partner</span>
                            </a>
                        </div>
                        <!--end:Item-->
                    </div>
            ...
            <div class="d-flex align-items-center mb-2">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                    ...
                    <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10 text-black" style="background-image:url('assets/media/misc/dropdown-header-bg.png')">
                        <!--begin::Title-->
                        <h3 class="fw-bold">Donasi & Sponsor</h3>
                        <!--end::Title-->
                    </div>
                    <!--end::Heading-->
                    <!--begin::Tab content-->
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
                            ...
                            <div class="d-flex flex-column px-9">
                                ...
                                <div class="pb-0">
                                    <!--begin::Text-->
                                    <div class="text-center text-black fw-bold pt-1">Dukung Digidik agar terus bisa berkarya memajukan pendidikan Indonesia.</div>
                                    <!--end::Text-->
                                    <!--begin::Action-->
                                    <div class="text-center mt-5 mb-9">
                                        <a href="https://kitabisa.com/campaign/bimbelonline" target="_blank" class="btn btn-sm btn-primary px-6">Donasi via KitaBisa</a>
                                        <a href="https://drive.google.com/file/d/1dFUeUaBIiMuPPs5f2JGSpQGFqqgzgPOB/view" target="_blank" class="btn btn-sm btn-primary px-6">Program Sponsorship</a>
                                    </div>
                                    <!--end::Action-->
                                </div>
                                <!--end::Section-->
        ...
        <div class="aside-workspace my-5 p-5" id="kt_aside_wordspace">
            <div class="d-flex h-100 flex-column">
                ...
                <div class="flex-column-fluid hover-scroll-y" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_aside_wordspace" data-kt-scroll-dependencies="#kt_aside_secondary_footer" data-kt-scroll-offset="0px">
                    ...
                    <div class="tab-content">
                        <!--begin::Tab pane-->
                        <div class="tab-pane fade @if(Request::is('profil/*')) active show @endif @if(Request::is('/')) active show @endif " id="kt_aside_nav_tab_projects" role="tabpanel">
                            <!--begin::Wrapper-->
                            <div class="mx-5">
                                <!--begin::Container-->
                                <div class="text-center">
                                    <!--begin::Title-->
                                    <div class="mb-4">
                                        <h2 class="fs-1 fw-bolder">DIGIDIK</h2>
                                        <span id="typed_digidik" class="fs-2  fw-bolder"></span>
                                    </div>
                                    <!--end::Title-->
                                    <!--begin::Description-->
                        ...
                        <!--end::Tab pane-->
                        <!--begin::Tab pane-->
                        <div class="tab-pane fade @if(strpos($routeName, 'video') === 0) active show @endif" id="kt_aside_nav_tab_menu" role="tabpanel">
                            <!--begin::Menu-->
                                
                                <div class="mx-5">
                                    <!--begin::Header-->
                                    <h3 class="fw-bolder  mb-10 mx-0">Video Belajar</h3>
                                    <!--end::Header-->
                                    <!--begin::Body-->
                                    <div class="mb-12">
                                        <!--begin::Item-->
                                        <a href="{{url('/video/sma')}}">
                                        <div class="d-flex align-items-center mb-7 @if(request()->is('video/sma') || request()->is('video/sma/*')) bg-danger rounded p-3 @endif">
                                            <!--begin::Symbol-->
                                        ...
                                        <!--begin::Item-->
                                        <a href="{{url('/video/smp')}}">
                                            <div class="d-flex align-items-center mb-7 @if(request()->is('video/smp') || request()->is('video/smp/*')) bg-danger rounded p-3 @endif">
                                                <!--begin::Symbol-->
                                                <div class="symbol symbol-50px me-5">
                                                    <span class="symbol-label bg-light-success">
                                                        <!--begin::Svg Icon | path: icons/duotone/Home/Library.svg-->
                                            ...
                                            <a href="{{route('video.tags')}}">
                                                <div class="d-flex align-items-center mb-7 @if(strpos($routeName, 'video.tags') === 0) bg-danger rounded p-3 @endif">
                                                    <!--begin::Symbol-->
                                                    <div class="symbol symbol-50px me-5">
                                                        <span class="symbol-label bg-light-success">
                                                            <!--begin::Svg Icon | path: icons/duotone/Home/Library.svg-->
                                                ...
                                                <!--begin::Item-->
                                            <a target="_blank" href="https://blog.digidik.id/utbk/">
                        ...
                        <div class="tab-pane fade" id="kt_aside_nav_tab_subscription" role="tabpanel">
                            ...
                            <div class="mx-5">
                                <!--begin::Header-->
                                <h3 class="fw-bolder  mb-10 mx-0">Dalam Proses Migrasi</h3>
                                <!--end::Header-->
                                <!--begin::Body-->
                                <div class="mb-12">
                                    <!--begin::Item-->
                                    <div class="d-flex align-items-center mb-7">
                                        ...
                                        <!--begin::Text-->
                                        <div class="d-flex flex-column">
                                            <a href="" class="text-gray-800 text-hover-primary fs-6 fw-bold">TryOut Latihan</a>
                                    ...
                                    <div class="d-flex align-items-center mb-7">
                                        ...
                                        <!--begin::Text-->
                                        <div class="d-flex flex-column">
                                            <a href="" class="text-gray-800 text-hover-primary fs-6 fw-bold">Tryout Nasional</a>
                                    ...
                                    <div class="d-flex align-items-center mb-7">
                                        ...
                                        <!--begin::Text-->
                                        <div class="d-flex flex-column">
                                            <a href="" class="text-gray-800 text-hover-primary fs-6 fw-bold">Hasil Tryoutmu</a>
                            ...
                            <div class="mx-5">
                                ...
                                <div class="mb-12">
                                    ...
                                    <div class="d-flex align-items-center mb-7">
                                        ...
                                        <!--begin::Text-->
                                        <div class="d-flex flex-column">
                                            <a href="" class="text-gray-800 text-hover-primary fs-6 fw-bold">Semua Pertanyaan</a>
                                    ...
                                    <div class="d-flex align-items-center mb-7">
                                        ...
                                        <!--begin::Text-->
                                        <div class="d-flex flex-column">
                                            <a href="" class="text-gray-800 text-hover-primary fs-6 fw-bold">Kirim Pertanyaan</a>
                                    ...
                                    <div class="d-flex align-items-center mb-7">
                                        ...
                                        <!--begin::Text-->
                                        <div class="d-flex flex-column">
                                            <a href="" class="text-gray-800 text-hover-primary fs-6 fw-bold">Pertanyaanmu</a>
                            ...
                            <div class="mx-5">
                                ...
                                <div class="mb-12">
                                    ...
                                    <div class="d-flex align-items-center mb-7">
                                        ...
                                        <!--begin::Text-->
                                        <div class="d-flex flex-column">
                                            <a href="" class="text-gray-800 text-hover-primary fs-6 fw-bold">Eksplorasi PTN</a>
                                    ...
                                    <div class="d-flex align-items-center mb-7">
                                        ...
                                        <!--begin::Text-->
                                        <div class="d-flex flex-column">
                                            <a href="" class="text-gray-800 text-hover-primary fs-6 fw-bold">Eksplorasi Jurusan</a>
                                    ...
                                    <div class="d-flex align-items-center mb-7">
                                        ...
                                        <!--begin::Text-->
                                        <div class="d-flex flex-column">
                                            <a href="" class="text-gray-800 text-hover-primary fs-6 fw-bold">Assessment</a>
                            ...
                            <div class="mx-5">
                                ...
                                <div class="mb-12">
                                    ...
                                    <div class="d-flex align-items-center mb-7">
                                        ...
                                        <!--begin::Text-->
                                        <div class="d-flex flex-column">
                                            <a href="https://blog.digidik.id/" target="_blank" class="text-gray-800 text-hover-primary fs-6 fw-bold">Artikel</a>
                                    ...
                                    <div class="d-flex align-items-center mb-7">
                                        ...
                                        <!--begin::Text-->
                                        <div class="d-flex flex-column">
                                            <a href="" class="text-gray-800 text-hover-primary fs-6 fw-bold">Buku Sekolah</a>
