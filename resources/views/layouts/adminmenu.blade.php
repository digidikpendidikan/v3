            ...
            <div class="hover-scroll-y mb-10" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_aside_nav" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-offset="0px">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="Selamat Datang">
                        <!--begin::Nav link-->
                        <a class="nav-link btn btn-icon btn-active-color-danger btn-color-gray-600 btn-active-light " data-bs-toggle="tab" href="#kt_aside_nav_tab_projects">
                    ...
                    <li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="Video Belajar">
                        <!--begin::Nav link-->
                        <a class="nav-link btn btn-icon btn-active-color-primary btn-color-gray-600 btn-active-light @if(strpos($routeName, 'admin.video') === 0) active @endif" data-bs-toggle="tab" href="#kt_aside_nav_tab_menu">
            ...
            <div class="d-flex h-100 flex-column">
                ...
                <div class="flex-column-fluid hover-scroll-y" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_aside_wordspace" data-kt-scroll-dependencies="#kt_aside_secondary_footer" data-kt-scroll-offset="0px">
                    ...
                    <div class="tab-content">
                        ...
                        <!--end::Tab pane-->
                        <!--begin::Tab pane-->
                        <div class="tab-pane fade @if(strpos($routeName, 'admin.video') === 0) active show @endif" id="kt_aside_nav_tab_menu" role="tabpanel">
                            <!--begin::Menu-->
                                ...
                                <div class="mx-5">
                                    ...
                                    <div class="mb-12">
                                        <!--begin::Item-->
                                        <a href="{{route('admin.video.level.index')}}">
                                        <div class="d-flex align-items-center mb-7 @if(strpos($routeName, 'admin.video.level') === 0) bg-danger rounded p-3 @endif">
                                            <!--begin::Symbol-->
                                            ...
                                            <div class="d-flex flex-column">
                                                <span class="@if(strpos($routeName, 'admin.video.level') === 0) text-white @else text-gray-800 @endif fs-6 fw-bold">Kelola Jenjang</span>
                                                <span class="@if(strpos($routeName, 'admin.video.level') === 0) text-white @else text-muted @endif fw-bold">Misal: SMA</span>
                                            </div>
                                            <!--end::Text-->
                                        </div>
                                        </a>
                                        ...
                                        <!--begin::Item-->
                                        <a href="{{route('admin.video.group.index')}}">
                                            <div class="d-flex align-items-center mb-7 @if(strpos($routeName, 'admin.video.group') === 0) bg-danger rounded p-3 @endif">
                                                <!--begin::Symbol-->
                                                <div class="symbol symbol-50px me-5">
                                                    <span class="symbol-label bg-light-success">
                                                        <!--begin::Svg Icon | path: icons/duotone/Home/Library.svg-->
                                                ...
                                                <!--begin::Text-->
                                                <div class="d-flex flex-column">
                                                    <span class="@if(strpos($routeName, 'admin.video.group') === 0) text-white @else text-gray-800 @endif fs-6 fw-bold">Kelola Kelas</span>
                                                    <span class="@if(strpos($routeName, 'admin.video.group') === 0) text-white @else text-muted @endif fw-bold">Misal: Kelas X</span>
                                                </div>
                                                <!--end::Text-->
                                            </div>
                                            </a>
                                        ...
                                        <!--begin::Item-->
                                        <a href="{{route('admin.video.subject.index')}}">
                                            <div class="d-flex align-items-center mb-7 @if(strpos($routeName, 'admin.video.subject') === 0) bg-danger rounded p-3 @endif">
                                                <!--begin::Symbol-->
                                                <div class="symbol symbol-50px me-5">
                                                    <span class="symbol-label bg-light-success">
                                                        <!--begin::Svg Icon | path: icons/duotone/Home/Library.svg-->
                                                ...
                                                <!--begin::Text-->
                                                <div class="d-flex flex-column">
                                                    <span class="@if(strpos($routeName, 'admin.video.subject') === 0) text-white @else text-gray-800 @endif fs-6 fw-bold">Kelola Mapel</span>
                                                    <span class="@if(strpos($routeName, 'admin.video.subject') === 0) text-white @else text-muted @endif fw-bold">Misal: Matematika</span>
                                                </div>
                                                <!--end::Text-->
                                            </div>
                                            </a>
                                        ...
                                        <!--begin::Item-->
                                        <a href="{{route('admin.video.chapter.index')}}">
                                            <div class="d-flex align-items-center mb-7 @if(strpos($routeName, 'admin.video.chapter') === 0) bg-danger rounded p-3 @endif">
                                                <!--begin::Symbol-->
                                                <div class="symbol symbol-50px me-5">
                                                    <span class="symbol-label bg-light-success">
                                                        <!--begin::Svg Icon | path: icons/duotone/Home/Library.svg-->
                                                ...
                                                <!--begin::Text-->
                                                <div class="d-flex flex-column">
                                                    <span class="@if(strpos($routeName, 'admin.video.chapter') === 0) text-white @else text-gray-800 @endif fs-6 fw-bold">Kelola Bab</span>
                                                    <span class="@if(strpos($routeName, 'admin.video.chapter') === 0) text-white @else text-muted @endif fw-bold">Misal: Bab Jamur</span>
                                                </div>
                                                <!--end::Text-->
                                            </div>
                                            </a>
                                            ...
                                            <!--begin::Item-->
                                        <a href="{{route('admin.video.lesson.index')}}">
                                            <div class="d-flex align-items-center mb-7 @if(strpos($routeName, 'admin.video.lesson') === 0) bg-danger rounded p-3 @endif">
                                                <!--begin::Symbol-->
                                                <div class="symbol symbol-50px me-5">
                                                    <span class="symbol-label bg-light-success">
                                                        <!--begin::Svg Icon | path: icons/duotone/Home/Library.svg-->
                                                ...
                                                <!--begin::Text-->
                                                <div class="d-flex flex-column">
                                                    <span class="@if(strpos($routeName, 'admin.video.lesson') === 0) text-white @else text-gray-800 @endif fs-6 fw-bold">Kelola Video</span>
                                                    <span class="@if(strpos($routeName, 'admin.video.lesson') === 0) text-white @else text-muted @endif fw-bold">Misal: Definisi Trigonometri</span>
                                                </div>
                                                <!--end::Text-->
                                            </div>
                                            </a>
                        ...
                        <div class="tab-pane fade" id="kt_aside_nav_tab_subscription" role="tabpanel">
                            ...
                            <div class="mx-5">
                                <!--begin::Header-->
                                <h3 class="fw-bolder  mb-10 mx-0">TryOut</h3>
                                <!--end::Header-->
                                <!--begin::Body-->
                                <div class="mb-12">
                                    <!--begin::Item-->
                        ...
                        <div class="tab-pane fade" id="kt_aside_nav_tab_tasks" role="tabpanel">
                            ...
                            <div class="mx-5">
                                <!--begin::Header-->
                                <h3 class="fw-bolder  mb-10 mx-0">Bertanya</h3>
                                <!--end::Header-->
                                <!--begin::Body-->
                                <div class="mb-12">
                                    <!--begin::Item-->
                        ...
                        <div class="tab-pane fade" id="kt_aside_nav_tab_notifications" role="tabpanel">
                            ...
                            <div class="mx-5">
                                <!--begin::Header-->
                                <h3 class="fw-bolder  mb-10 mx-0">Kuliah</h3>
                                <!--end::Header-->
                                <!--begin::Body-->
                                <div class="mb-12">
                                    <!--begin::Item-->
                        ...
                        <div class="tab-pane fade" id="kt_aside_nav_tab_authors" role="tabpanel">
                            ...
                            <div class="mx-5">
                                <!--begin::Header-->
                                <h3 class="fw-bolder  mb-10 mx-0">Fitur Belajar</h3>
                                <!--end::Header-->
                                <!--begin::Body-->
                                <div class="mb-12">
                                    <!--begin::Item-->
